  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between gap-10">
        ...
        <div className="w-1/3 flex items-center ml-[150px] gap-4">
      ...
      <div className="pt-3 w-full">
        <ul className="flex items-center">
          ...
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">About Us</li>
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">Products</li>
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">FAQs</li>
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">Testimonials</li>
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">Blogs</li>
          <li className="py-3 px-10 mr-2 bg-[#057793] text-white text-lg font-bold">Contact Us</li>
